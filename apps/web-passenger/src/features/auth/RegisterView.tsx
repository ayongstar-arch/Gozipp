...
const RegisterView: React.FC = () => {
  ...
  return (
    <AuthLayout
      title="ลงทะเบียนใหม่"
      subtitle="เข้าร่วม GOZIPP เดินทางฉลาด รวดเร็ว ทั่วเมือง"
      showBackButton={true}
      ...
      >
        ...
        <div className="space-y-4">
          <label className="block relative">
            <span className="absolute -top-3 left-4 bg-[#04070B] px-2 text-xs font-bold text-[#A3FF3F] uppercase tracking-wider z-10">ชื่อ-นามสกุล</span>
            <input
              type="text"
          ...
          <label className="block relative">
            <span className="absolute -top-3 left-4 bg-[#04070B] px-2 text-xs font-bold text-[#A3FF3F] uppercase tracking-wider z-10">เบอร์โทรศัพท์</span>
            <input
              type="tel"
